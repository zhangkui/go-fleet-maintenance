...
## Docker Build Template
    ...
    ./build_benzhi_docker.sh go-fleet-maintenance-bug004-candidate linux/amd64

The Docker command is an evaluation template only. Docker and architecture validation were not run.

## BUG-004 Verification Command

    cd '/app' && GOTOOLCHAIN=local go test ./internal/service -count=1 -run '^TestBug004_RegistrationAssignsOperatorRole$'
